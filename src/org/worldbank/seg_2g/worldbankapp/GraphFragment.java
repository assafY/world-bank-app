				...
				if (data == null) {
					...
					try {
			            ...
			            for (int i = 0; i < totalEntries; ++i) {
			                ...
			                // get population first digit and add to list used for y axis label
			                /*int popLabel = population;
			                while (popLabel > 9) {
			                	Math.abs(popLabel);
			                }*/
			                axisValues.add(new AxisValue(population));
			            }
			            ...
			            Axis axisX = new Axis();
						Axis axisY = new Axis().setAutoGenerated(false).setHasLines(true).setMaxLabelChars(9).setValues(axisValues);
